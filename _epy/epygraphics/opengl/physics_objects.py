...
class Sand(PhysicsObject):
	def __init__(self, *args, **kwargs):
		...
		self.color = (random.uniform(0.80, 0.92), 0.70, 0.50)
		self.movement = 1
		self.type = "Sand"
		self.density = 2
	...
	def force(self, *m):
		...
		self.relmove(*m) #Translates itself downwards
		self.global_states[self.coords] = self #set new location to yourself
		
		if existing_pixel:
			existing_pixel.absmove(*current_coords)
...
class Water(PhysicsObject):
	def __init__(self, *args, **kwargs):
		...
		self.color = (0.70, random.uniform(0.85, 0.94), 0.96)
		self.movement = 1
		self.since_down = 0
...
class Wire(Concrete):
	def __init__(self, *args, **kwargs):
		...
		self.color = rgb_decimal(212, 123-val1, 83-val1)
		self.off_color = self.color
		val1 = random.randint(0, 20)
...
class Chargestone(Concrete):
	def __init__(self, *args, **kwargs):
		...
		if yellow == 1:
			...
			self.color = rgb_decimal(205-(val1*0.3), 255, 135-val1)  #191, 252, 106
		else:
			val1 = random.randint(0, 40)
			self.color = rgb_decimal(144-val1, 255-(val1*0.3), 140-val1) #144, 255, 140 #108, 240, 104
...
class Dirt(Sand):
	def __init__(self, *args, **kwargs):
		...
		if grey == 1:
			...
			self.color = (0.46-val1, 0.38-val1, 0.30-val1)
		else:
			val1 = random.uniform(0.0, 0.1)
			self.color = (0.61-val1, 0.46-val1, 0.33)
		self.type = "Dirt"
...
class Smoke(Water):
	def __init__(self,  *args, **kwargs):
		...
		self.color = (0.25-val1, 0.25-val1, 0.25-val1)
...
class Steam(Smoke):
	def __init__(self, *args, **kwargs):
		...
		self.color = rgb_decimal(222-val1, 222-val1, 222-val1)

class Wood(Concrete):
	def __init__(self, *args, **kwargs):
		super(Wood, self).__init__(*args, **kwargs)
		val1 = random.uniform(0.0, 0.04)
		self.color = (0.2-val1, 0.13-val1, 0.06-val1)
		self.type = "Wood"
		self.flamability = 7
...
class Biomatter(Concrete):
	def __init__(self, *args, **kwargs):
		...
		if color == 1:
			self.color = rgb_decimal(88-val1, 127-val1, 95-val1)
		elif color == 2:
			self.color = rgb_decimal(52-(val1*0.5), 60-(val1*0.35), 53-(val1*0.5))
		else:
			self.color = rgb_decimal(55, 48-val2, 35-(val2*0.5))
...
class Fire(PhysicsObject):
	def __init__(self, *args, **kwargs):
		...
		self.color = (val2, 0.9-val1, random.uniform(0, 0.11))
...
class Oil(Water):
	def __init__(self, *args, **kwargs):
		...
		self.color = rgb_decimal(20-val1, 12-(val1*0.5), 0)
		self.type = "Oil"
		self.flamability = 15
		self.density = 0.9
...
class Salt(Sand):
	def __init__(self, *args, **kwargs):
		...
		self.color = rgb_decimal(255-val1, 215-(0.6*val2), 205-val2)
		self.type = "Salt"
		self.density = 100
		self.active = False
...
class Methane(Water):
	def __init__(self, *args, **kwargs):
		...
		val1 = random.randint(0, 20)
		self.color = rgb_decimal(247-val1, 255-(val1*0.5), 217-val1)
		self.type = "Methane"
		self.flamability = 25
		self.density = 0.1
		self.movement = -1
...
class Charcoal(Sand):
	def __init__(self, *args, **kwargs):
		...
		if light == 1:
			...
			self.color = rgb_decimal(80-val1, 80-val1, 80-val1)
		else:
			val1 = random.randint(0, 20)
			self.color = rgb_decimal(50-val1, 50-val1, 50-val1)
		self.type = "Charcoal"
		self.flamability = 5
		self.density = 2
...
class Ember(Sand):
	def __init__(self, *args, **kwargs):
		...
		self.color = rgb_decimal(120+val1, 60-val2, 0)
		self.type = "Ember"
